...
const testimoinials = ref([
  {
    ...
    // title: "Senior Nurse",
    name: "Sarah M",
    desc: "I can't express how grateful I am to Wana Healthcare & Services for the exceptional care they provided to my elderly mother. The caregivers were not only competent but also sympathetic, treating her with dignity and respect. Their concern for my mother's well-being enabled her to remain in the comfort of her own home, which meant the world to our family. Wana Healthcare & Services certainly made a difference in our life during a difficult period.",
    stars: 5,
  },
  {
    img: "jessie",
