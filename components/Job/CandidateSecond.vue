          ...
          >
            ...
            <div class="w-full">
              ...
              <select
                ...
                name="country"
                required
                class="border border-grey-6 bg-white rounded-lg py-4 px-4 focus:outline-none w-full h-12"
                :class="errorMsg.name ? 'border border-red-500' : ''"
                placeholder="+1(555) 000-000"
              >
                <option
          ...
          >
            <div class="w-full">
              ...
              <select
                ...
                name="specialty"
                required
                class="border border-grey-6 bg-white rounded-lg py-4 pl-4 pr-2 focus:outline-none w-full h-12"
                :class="errorMsg.name ? 'border border-red-500' : ''"
                placeholder="+1(555) 000-000"
              >
                <option
            ...
            <div class="w-full">
              <p>Employment Type</p>
              <div class="type flex flex-col my-3">
                <label>
                  <input
                    type="radio"
                    name="employmentType"
                ...
                <label>
                  <input
                    ...
                    name="employmentType"
                    id="temporaryPart"
                    value="temporary parttime"
                  />
                  <span>Temporary (Part time)</span>
                </label>
              </div>
            </div>
            <div class="flex w-full">
            ...
            <div class="w-full">
              <p>Upload your CV</p>
              <div
                class="drop-area rounded-lg mt-2 bg-white border-dashed border-grey-6 py-10 px-6 flex flex-col items-center text-center border"
                @dragover="dragover"
                @dragleave="dragleave"
                @drop="drop"
              >
                ...
                <div>
                  <label for="file-input">
                    <p class="mb-4">Drag and Drop Files Here</p>
                    <p
                      class="bg-secondary rounded-lg px-3 py-3 cursor-pointer font-semibold text-sm text-white"
                    >
                      Select from Device
                    </p>
                  </label>
                  <ul v-if="fileList.length" class="mt-4">
                    <li
                      class="text-sm p-1"
