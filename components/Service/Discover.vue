...
<template>
  <div class="bg-white px-4 xl:px-0">
    ...
    <!-- <div class="py-20 md:py-16 mx-auto w-full max-w-[1240px]">
      <div class="w-full flex flex-col md:items-start gap-10">
        ...
        <p
          class="capitalize leading-[40px] md:leading-[44px] text-[24px] md:text-[28px]"
        >
          <span class="font-medium"
            >Join us today and taste the difference.</span
          >
          We guarantee you regular shifts and if you want permanent placement on
          contract that’s nothing to worry about DCS representatives will get
          your desired job position in matters of days. All we require of you is
          to become compliant and pass all pre-employment checks. We have lots
