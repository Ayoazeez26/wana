...
<template>
  <div class="py-20 px-4 xl:px-0 md:pt-28 md:pb-[120px] w-full">
    <div class="w-full max-w-[1240px] flex mx-auto">
      <div
        class="flex flex-col lg:flex-row gap-10 justify-between lg:items-center w-full max-w-[1240px]"
      >
        <img
        ...
        <div class="flex flex-col w-full max-w-[572px]">
          <h1
            class="font-medium text-head leading-snug text-[38px] lg:leading-snug lg:text-[48px]"
          >
